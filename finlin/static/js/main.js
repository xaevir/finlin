var paper = new Raphael(document.getElementById('logo-svg'), 28, 33);  
...
inner.attr({'fill': 'none', 'stroke':'none', 'scale':'.8, .8, 0, 0'})
...
st.attr({'stroke': 'none', 'fill':'#FF5100', 'scale':'.8, .8, 0, 0'})

//cloned = st.clone()
//cloned.attr({ 'fill':'#fff' })
//cloned.translate(2,0)
